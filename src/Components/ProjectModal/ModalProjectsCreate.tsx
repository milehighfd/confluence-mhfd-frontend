        ...
        <div className='create-projects-modal'>
          ...
          {<Row className='row-project-project'>
            ...
            : <div className='nothing-found'>
                ...
                <p>Try modifying your search parameter, or if still unable to locate, proceed to <span style={{color:'#29C499', textDecoration:'underline', cursor:'pointer'}}   onClick={onClickNewProject}>create a project</span>.
                </p>
              </div>
          }
        </div>
