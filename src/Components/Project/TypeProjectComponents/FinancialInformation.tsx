    ...
    <div>
      ...
      <Row className="sub-project">
        <Col xs={{ span: 24 }} lg={{ span: 14 }} xxl={{ span: 17 }}>
          <p className='title-sub-project'>Overhead Cost &nbsp;&nbsp;<Popover content={contentOverheadCost}><img src="/Icons/icon-19.svg" alt="" height="12px" /></Popover></p>
        </Col>
      ...
      <Timeline className="sub-project" style={{marginTop:'10px'}}>
        ...
        <Row className="sub-project">
          <Col xs={{ span: 18 }} lg={{ span: 13 }} xxl={{ span: 13 }}>
            <p className='title-sub-project recomended-margin'>RECOMMENDED PROJECT BUDGET &nbsp;&nbsp;<Popover content={contentRecommendedBudget}><img src="/Icons/icon-19.svg" alt="" height="12px" /></Popover></p>
          </Col>
          <Col xs={{ span: 24 }} lg={{ span: 8 }} xxl={{ span: 8 }} className='col-input-badget'>
        ...
        <div className='budget-container'>
          <Row className="sub-project">
            <Col xs={{ span: 24 }} lg={{ span: 18 }} xxl={{ span: 18 }}>
              <p className='title-sub-project'>ACTUAL PROJECT ESTIMATED COST &nbsp;&nbsp;<Popover content={contentActualEstimatedCost}><img src="/Icons/icon-19.svg" alt="" height="12px" /></Popover></p>
            </Col>
