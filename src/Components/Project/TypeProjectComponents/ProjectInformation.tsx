...
export const ProjectInformation = ({
  ...
  return (
    <>
      ...
      /></>)}
      <label className="sub-title">Description <Popover overlayClassName="project-popover" content={content00}><img src="../Icons/icon-19.svg" alt="" height="10px" /></Popover></label>
