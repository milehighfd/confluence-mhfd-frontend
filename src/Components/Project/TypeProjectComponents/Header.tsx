  ...
  return (
    <div className="head-project">
      ...
      <div className='project-type'>
        {isEdit?<p>{selectedType === 'Special'? 'R&D':selectedType }</p>:<Dropdown overlay={menuTypeProjects} trigger={['click']} overlayClassName="drop-menu-type-project" placement="bottomRight" onVisibleChange={() => { setOpenDropdownTypeProject(!openDropdownTypeProject) }}>
