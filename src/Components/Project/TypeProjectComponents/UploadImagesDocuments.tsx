      ...
      <div className="upload-documents">
        <div className="sub-title-project sub-title-project-upload">
          <h5 className="requestor-information">{index}
            . Upload images <img src="/Icons/icon-19-black.svg" alt="" height="14px" className="icon-upload"/>
          </h5>
      ...
      <div className="upload-documents">
        <div className="sub-title-project sub-title-project-upload">
          <h5 className="location">{index+1}
            . Upload documents <img src="/Icons/icon-19-black.svg" alt="" height="14px" className="icon-upload"/>
          </h5>
          <div className="group-btn">
