  ...
  return (
    ...
    <div className="location-information">
      <div className="sub-title-project">
        <h5 className="location">{index}. LOCATION <Popover overlayClassName="project-popover" content={contentLocInf}><img src="/Icons/icon-19.svg" alt="" height="14px" /></Popover></h5>
      </div>
      <Row gutter={[16, 16]}>
        <Col xs={{ span: 24 }} lg={{ span: 12 }}>
          <label className="sub-title">Service Area <Popover overlayClassName="project-popover" content={contentSerAre}><img src="/Icons/icon-19.svg" alt="" height="10px" /></Popover></label>
        ...
        <Col xs={{ span: 24 }} lg={{ span: 12 }}>
          <label className="sub-title">County <Popover overlayClassName="project-popover" content={contentCounty}><img src="/Icons/icon-19.svg" alt="" height="10px" /></Popover></label>
          {(isMaintenance || isStudy) && !isWorkPlan && <>
      ...
      <Row gutter={[16, 16]} style={{marginTop:'10px'}}>
        <Col xs={{ span: 24 }} lg={{ span: 12 }}>
          <label className="sub-title">Local Government <Popover overlayClassName="project-popover" content={contentJuris}><img src="/Icons/icon-19.svg" alt="" height="10px" /></Popover></label>
          {(isMaintenance || isStudy) && !isWorkPlan && <>
            <span id="required-location" className="requiered">&nbsp;*&nbsp;</span>
            </>}
