...
const content03 = (<div className="popver-info"><b>Frequency:</b> Indicates the number of times per-year that a maintenance activity is requested for routine activities. For example, select 2 for twice-per-year, or select 12 for monthly.</div>);
const content05 = (<div className="popver-info" style={{ width: '261px' }}> <b>Maintenance Eligibility:</b> Indicate why this project is eligible for MHFD maintenance. <br /><br /><b>Capital Project</b> - The project was completed as part of a MHFD Capital Improvement Plan
...
const content04 = (<div className="popver-info"><b>Access Control:</b> Flip this switch to indicate that the project is located on a property to which the Local Government has legal right-of-access. This is a requirement for all Maintenance Projects.</div>);
const selec = ['None'];
for (var i = 1; i < 13; i++) {
  selec.push('' + i);
}
