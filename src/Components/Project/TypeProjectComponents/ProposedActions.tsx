...
export const ProposedActions = (props: ProposedActionsProps) => {
  ...
  return (
    <>
      ...
      <Button disabled={disableFieldsForLG} className="btn-transparent-green" onClick={() => { applyIndependentComponent() }}><PlusCircleFilled /> Independent Actions</Button> <Popover content={contentIndComp}><img src="/Icons/icon-19-black.svg" alt="" height="10px" className='icon-actions' /></Popover>
    </>
  );
}
