  ...
  return (
    <div>
      <div className="sub-title-project">
        <h5 className="requestor-information">{index}. SPONSOR INFORMATION <Popover content={contentLocInf}><img src="/Icons/icon-19-black.svg" alt="" height="14px" /></Popover></h5>
      </div>
      <Row gutter={[16, 16]} style={{ marginTop: '10px' }}>
        <Col xs={{ span: 24 }} lg={{ span: 12 }}>
          <label className="sub-title">Sponsor&nbsp;&nbsp;* <Popover content={content03}><img src="/Icons/icon-19-black.svg" alt="" height="10px" /></Popover></label>
          <div id="sponsorid">
            <Select
              style={{ width: '100%' }}
        ...
        <Col xs={{ span: 24 }} lg={{ span: 12 }}>
          <label className="sub-title">Potential Co-Sponsor <Popover content={content04}><img src="/Icons/icon-19-black.svg" alt="" height="10px" /></Popover></label>
