                          ...
                          >
                            <Panel
                              ...
                              header={!openCollaps
                                ...
                                : <a href="#openCost" style={{padding:'10px'}}  onClick={() => (setOpenCollaps(sumByCounty.length === 0 ? openCollaps : !openCollaps))} ><UpSquareOutlined style={{height:'16px', width:'16px', color: '#251863'}} onClick={() => (setOpenCollaps(sumByCounty.length === 0 ? openCollaps : !openCollaps))}/></a>}
                              key="1"
