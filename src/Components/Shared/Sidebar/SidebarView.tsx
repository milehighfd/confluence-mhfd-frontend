    ...
    <Menu theme="dark" defaultSelectedKeys={[indexOf]} mode="inline" >
      ...
      <Menu.Item key="0" className="menu-mobile">
        <Link to={'/profile-view'} >
          <img className="img-h anticon" src="/Icons/menu-white-01.svg" alt="" width="22px"/>
          <img className="img-a anticon" src="/Icons/menu-green-01.svg" alt="" width="22px" />
          <span style={{marginLeft: collapsed ? '-20px' : '-4px'}}>my confluence</span>
        </Link>
      </Menu.Item> : ''}
      <Menu.Item key="1" className="menu-mobile">
        <Link to={'/map'}>
          <img className="img-h anticon" src="/Icons/menu-white-02.svg" alt="" width="22px" />
          <img className="img-a anticon" src="/Icons/menu-green-02.svg" alt="" width="22px" />
          <span style={{marginLeft: collapsed ? '-20px' : '-4px'}}>map view</span>
        </Link>
      </Menu.Item>
      {showWorkRequestPlan &&
        <Menu.Item key="4" className="menu-mobile">
          <Link to={userApproved ? '/work-request': '#'}>
            <img className="img-h anticon" src="/Icons/menu-white-14.svg" alt="" width="22px" style={{opacity: userApproved ? '1': '0.2'}} />
            <img className="img-a anticon" src="/Icons/menu-green-14.svg" alt="" width="22px" style={{opacity: userApproved ? '1': '0.2'}} />
            <span>work request</span>
            <span style={{marginLeft: collapsed ? '-20px' : '-4px'}}>work request</span>
          </Link>
        </Menu.Item>
      }
      {showWorkRequestPlan ?
      <Menu.Item key="3" className="menu-mobile">
        <Link to={userApproved ? '/work-plan': '#'}>
          ...
          <span style={{marginLeft: collapsed ? '-20px' : '-2px'}}>project management</span>
        </Link>
      </Menu.Item> : ''}
      {(appUser.designation !== 'guest') ?
