      ...
      <Checkbox.Group value={selectedLayers} onChange={(items) => {
        ...
        <Collapse defaultActiveKey={['6asdffds', '1', '2', '3', '4', '5', '6', '7', '8']} key="V4mBA5NQvgvvxJt0">
          ...
          <Panel header="" key="1" extra={genExtra()}>
            ...
            <p>
              <img key="hygfgsbnF7gs" src="/Icons/icon_problem.png" width="18px" alt="" />
                  Problems
                  <Popover key="uibfUYSsd7" arrowPointAtCenter overlayClassName="popover-filter-map" content={contentPopOver(popUps.problem, 'Problems – ')}>
          ...
          <Panel header="" key="4" extra={genExtra03()}>
            ...
            <p>
              <img key="Bp89Di5Bmf75" src="/Icons/ic_smc_ml.png" width="18px" alt="" style={{borderRadius:'2px'}}  />
