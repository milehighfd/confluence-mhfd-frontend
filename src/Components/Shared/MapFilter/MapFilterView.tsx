      ...
      <Checkbox.Group value={selectedLayers} onChange={(items) => {
        ...
        <Collapse defaultActiveKey={['1', '2', '3', '4', '5', '6', '7', '8']}>
          <Panel header="" key="1" extra={genExtra()}>
            <p>
              <img src="/Icons/Filters/ic_problems.png" alt="" />
                  Problems
            ...
            <p>
              <img src="/Icons/Filters/ic_components.png" alt="" />
                  Components
            ...
            <p>
              <img src="/Icons/Filters/ic_projects.png" alt="" />
                  Projects
            ...
            <p>
              <img src="/Icons/Filters/ic_MEP.png" alt="" />
                  MEP Projects
            ...
            <p>
              <img src="/Icons/Filters/ic_routine.png" alt="" />
                  Routine Maintenance
          ...
          <Panel header="" key="2" extra={genExtra01()}>
            <p>
              <img src="/Icons/Filters/ic_watersheds.png" alt="" />
                  Watersheds
            ...
            <p>
              <img src="/Icons/Filters/ic_NRCS.png" alt="" />
                  NRCS Soils
            ...
            <p style={{ display: 'none' }}>
              <img src="/Icons/Filters/ic_stream.png" alt="" />
                  Streams
          ...
          <Panel header="" key="3" extra={genExtra02()}>
            <p>
              <img src="/Icons/Filters/ic_flood.png" alt="" />
                  Floodplains
            ...
            <p>
              <img src="/Icons/Filters/ic_FEMA.png" alt="" />
            ...
            <p>
              <img src="/Icons/Filters/ic_DWR.png" alt="" />
                  DWR Dam Safety
          ...
          <Panel header="" key="5" extra={genExtra04()}>
            <p>
              <img src="/Icons/Filters/ic_mouse.png" alt="" />
                  BCZ - Preble’s Meadow
            ...
            <p>
              <img src="/Icons/Filters/ic_BCZ-ute.png" alt="" />
            ...
            <p>
              <img src="/Icons/Filters/ic_research.png" alt=""  />
                  Research/Monitoring
          ...
          <Panel header="" key="6" extra={genExtra05()}>
            <p>
              <img src="/Icons/Filters/ic_climb.png" alt="" />
          ...
          <Panel header="" key="7" extra={genExtra06()}>
            <p>
              <img src="/Icons/Filters/ic_service.png" alt="" />
                  Service Areas
            ...
            <p>
              <img src="/Icons/Filters/ic_counties.png" alt="" />
                  Counties
            ...
            <p>
              <img src="/Icons/Filters/ic_municipalities.png" alt="" />
                  Municipalities
            ...
            <p>
              <img src="/Icons/Filters/ic_SEMSWA.png" alt="" />
                  SEMSWA Service Area
