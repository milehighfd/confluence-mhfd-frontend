...
import { NEW_PROJECT_FORM_COST, FOOTER_PROJECT_CAPITAL } from "../../constants/constants";
...
const NewMapFormView = ({ selectedItems, isPolygon, setSelectedItems, saveNewProjectForm } : any) => {
...
export default mapFormData(NewMapFormView);
