...
const UserList = () => {
  ...
  const menu = (record:any, onExpand:any)=> {
    switch (record.status) {
      case 'approved':
        items = [
          { key: 'edit-user', label: <div style={{alignItems:'center', display:'flex', color:'#002633', justifyContent:'initial'}}><img src={'/Icons/fi_clipboard.svg'} alt='ico-clip'/>&nbsp;&nbsp;Edit User</div> },
          { key: 'delete-user', label: <div style={{alignItems:'center', display:'flex', color:'#FF5722', justifyContent:'initial'}}><img src={'/Icons/frame-delete.svg'} alt='ico-clip'/>&nbsp;&nbsp;Delete User</div> },
        ];
        break;
      case 'deleted':
        items = [
