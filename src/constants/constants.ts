...
export const popUps = {
  ...
  block_clearence_zones: 'Preble’s Meadow Jumping Mouse and Ute Ladies Tresses Orchid have been block cleared by the U.S. Fish and Wildlife in the corresponding areas where there is sufficient information to indicate endangered/threatened species are absent from these large acreages.',
