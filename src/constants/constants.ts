...
export const MHFD_PROJECTS = (process.env.REACT_APP_PROJECTS_TABLE ? process.env.REACT_APP_PROJECTS_TABLE : 'mhfd_projects')+ (process.env.REACT_APP_NODE_ENV ? ( '_' + ((process.env.REACT_APP_NODE_ENV === 'production' || process.env.REACT_APP_NODE_ENV === 'prod' ) ? 'prod' :  process.env.REACT_APP_NODE_ENV) ) : '_dev');
export const PROJECTS_DRAFT = (process.env.REACT_APP_PROJECTS_TABLE ? process.env.REACT_APP_PROJECTS_TABLE : 'mhfd_projects')+ (process.env.REACT_APP_NODE_ENV ? ( '_' + ((process.env.REACT_APP_NODE_ENV === 'production' || process.env.REACT_APP_NODE_ENV === 'prod' ) ? 'prod' :  process.env.REACT_APP_NODE_ENV) ) : '_dev');
console.log('*****\nTable of projects\n*****\n', MHFD_PROJECTS);
// export const MHFD_PROJECTS = 'mhfd_projects' + (process.env.REACT_APP_NODE_ENV ? ( '_' + ((process.env.REACT_APP_NODE_ENV === 'production' || process.env.REACT_APP_NODE_ENV === 'prod' ) ? 'prod' :  process.env.REACT_APP_NODE_ENV) ) : '_dev')
...
export const popUps = {
  ...
  streams: 'Stream delineations derived from digital elevation model analysis and drainageways relating to completed projects, symbolized by catchment area.',
  problem: ' specific deficiencies in the Urban Stream System that warrant Proposed Actions. Problems are derived by vetting Concerns through the Planning process. Examples include undersized culverts, eroding banks, failing drop structures, and increased runoff volume.',
  problem_group:' the data elements that establish the relationship between Problems and Proposed Actions in MHFD Confluence.',
  component: 'proposed activities to solve Problems and address Opportunities. Proposed Actions are the building blocks for Improvement Projects in the Work Request module of Confluence.',
...
export const ICON_POPUPS = [
  ...
  ["Storm Drain", "/Icons/ic_actions_line_stormdrain.png"],
  ["Special Item Point", "/Icons/ic_actions_point_special.png"],
  ["Special Item Linear", "/Icons/ic_actions_line_special.png"],
  ["Special Item Area", "/Icons/ic_actions_polygon_special.png"],
  ...
  ["Land Acquisition", "/Icons/ic_actions_polygon_landacquisition.png"],
  ["Grade Control Structure", "/Icons/ic_actions_point_gradecontrol.png"],
  ["Detention Facilities", "/Icons/ic_actions_polygon_detentionfacility.png"],
  ["Stream Improvement Measure Copy", "/Icons/ic_actions_line_streamimprovement.png" ],
  ...
  ['Stream Condition Point', '/Icons/ic_problems_point_strmfunction.png'],
  ['Stream Condition Line', '/Icons/ic_problems_line_strmfunction.png'],
  ['Stream Condition Polygon',"/Icons/ic_problems_polygon_strmfunction.png"],
  ['Watershed Change Line', '/Icons/ic_problems_line_futrdev.png'],
  ['Watershed Change Point', '/Icons/ic_problems_point_futrdev.png'],
  ['Watershed Change Polygon', '/Iconsic_problems_polygon_futrdev.png'],
...
export const notComponentOptions: any[] = [
...
export const YEAR_LOGIC_2023 = 2023;
...
export const LOCALITIES_TYPES = {
  CODE_STATE_COUNTY : 'CODE_STATE_COUNTY',
