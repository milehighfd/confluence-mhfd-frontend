...
export const MAP_DROPDOWN_ITEMS = [
    {
      ...
      type: 'Optional style',
      style: `mapbox://styles/milehighfd/ckd9o19kq0e9x1ipdm8zdq98m`,
    }, {
        type: 'Dark Road',
...
export const STREAMS_FILTERS = 'mhfd_stream_reaches';
...
export const popUps = {
  ...
  borders: 'Borders of area',
  area_based_mask:'Mask to see only area'
}
