...
export default function (WrappedComponent : any, layers : any) {
    return ({ problems, projects, components, saveNewCapitalForm, saveNewProjectWithCoords, saveNewStudyForm, saveNewMaintenanceForm, getReverseGeocode, savePolygonCoordinates, saveMarkerCoordinates, redirect, setRouteRedirect, error, clearErrorMessage } : MapHOCProps) => {
