...
export const SERVER = (function () {
    ...
    return {
        ...
        COUNT_SEARCH_GLOBAL_PROJECTS: `${URL_BASE.BASE}/${PROJECT}/count-search`,
        SEARCH_BOARDS_IMPORT: `${URL_BASE.BASE}/${PROJECT}/search-import`,
        ...
        ALL_MAP_TABLES: `${URL_BASE.BASE}/${MAP}/all-tables`,
        ...
        GET_PROJECT_DATA: (project_id: any) => `${URL_BASE.BASE}/${FAVORITES}/project-cards/${project_id}`,
        ...
        ACTIVE_DETAILS: `${URL_BASE.BASE}/${PROJECT}/active-details`,
        ...
        GET_LIST_PMTOOLS: (code_project_type_id: number) =>
            `${URL_BASE.BASE}/${PMTOOLS}/list${code_project_type_id !== 0 ? `?code_project_type_id=${code_project_type_id}` : ''}`,
        ...
        GET_ALL_GROUPS: `${URL_BASE.BASE}/${PMTOOLS}/all-groups`,
        GET_COUNTER_FOR_GROUPS: (groupname: string) => `${URL_BASE.BASE}/${PMTOOLS}/groupsFilter/allcount/${groupname}`,
