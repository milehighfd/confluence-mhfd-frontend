...
export const SERVER = (function () {
    ...
    const CREATEPROJECTSTUDYMASTER = 'createStudyMasterPlan';
    const CREATEPROJECTSTUDYFHAD = 'createStudyFHAD';
    return {
        ...
        CREATEPROJECTSTUDYMASTER: `${URL_BASE.BASE}/${PROJECT}/${CREATEPROJECTSTUDYMASTER}`,
        CREATEPROJECTSTUDYFHAD: `${URL_BASE.BASE}/${PROJECT}/${CREATEPROJECTSTUDYFHAD}`,
    }
})();