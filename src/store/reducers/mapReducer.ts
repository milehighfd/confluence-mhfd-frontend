...
const initState = {
    ...
    filterProblemOptions: {
        ...
        problemtype: '',
        source: '',
        components: 'grade_control_structure,pipe_appurtenances,special_item_point,special_item_linear,special_item_area,channel_improvements_linear,channel_improvements_area,removal_line,removal_area,storm_drain,detention_facilities,maintenance_trails,land_acquisition,landscaping_area'
    },
    filterProjectOptions: {
        ...
        startyear: '',
        completedyear: '',
        mhfddollarsallocated: '20,15,10,5,1',
        lgmanager: '',
        streamname: '',
        creator: '',
    ...
    filterComponentOptions: {
        component_type: 'grade_control_structure,pipe_appurtenances,special_item_point,special_item_linear,special_item_area,channel_improvements_linear,channel_improvements_area,removal_line,removal_area,storm_drain,detention_facilities,maintenance_trails,land_acquisition,landscaping_area',
