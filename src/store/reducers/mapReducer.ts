...
const initState = {
    ...
    filterProblemOptions: {
        ...
        solutionstatus: '75,50,25,10',
        county: 'Jefferson',
        jurisdiction: '',
        mhfdmanager: '',
        problemtype: '',
        source: '',
        components: 'grade_control_structure,pipe_appurtenances,special_item_point,special_item_linear,special_item_area,removal_line,removal_area,storm_drain,detention_facilities,maintenance_trails,land_acquisition,landscaping_area,channel_improvements_linear,channel_improvements_area'
    },
    filterProjectOptions: {
        keyword: '',
        column: 'streamname',
        order: 'asc',
        projecttype: 'Capital,Maintenance,Study',
        status: 'Complete,Idle,Initiated,Ongoing,Requested',
        startyear: '',
        completedyear: '',
        mhfddollarsallocated: '20,15,10,5,0',
        lgmanager: '',
        streamname: '',
        creator: '',
        totalcost: '20,15,10,5,0',
        workplanyear: '2019,2020,2021,2022,2023',
        problemtype: '',
        mhfdmanager: '',
        jurisdiction: '',
        county: ''
    ...
    filterComponentOptions: {
        component_type: 'grade_control_structure,pipe_appurtenances,special_item_point,special_item_linear,special_item_area,landscaping_area,land_acquisition,maintenance_trails,detention_facilities,storm_drain,channel_improvements_linear,channel_improvements_area,removal_line,removal_area',
        status: 'Capital,Constructed,Existing,Proposed',
        yearofstudy: '1970,1980,1990,2000,2010,2020',
        estimatedcost: '8,6,4,2,0',
        jurisdiction: '',
        county: '',
        mhfdmanger: ''
    },
