...
const initState = {
    ...
    latitude: 0,
    selectedLayers: [
        STREAMS_FILTERS, PROJECTS_MAP_STYLES, PROBLEMS_TRIGGER, MHFD_BOUNDARY_FILTERS, XSTREAMS
    ],
    galleryProblems: [],
    galleryProjects: [],
    galleryProjectsV2: [],
...
const mapReducer = (state = initState, action: any) => {
    switch (action.type) {
        ...
        case types.GALLERY_PROJECTS_IDS_V2: {
          return {
            ...state,
            projectsids: action.projectsids
          }
        }
        ...
        case types.RESET_FILTER_PROJECT_OPTIONS: {
          return {
            ...state,
